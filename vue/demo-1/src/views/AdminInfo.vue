...
export default {
  ...
  methods:{
    ...
    handleDetail(id){
      // console.log(id)
      request.delete("/admin/admin_info/"+id).then(res=>{
        if(res.code=='200'){
          this.$message({
            type:"success",
            message:"删除成功"
    ...
    save(){
      ...
      if(this.admin_form.id){
        request.put("/admin/admin_info",this.admin_form).then(res=>{
          // console.log(res)
          if(res.code=='200'){
            this.$message({
              type:"success",
        ...
        request.post("/admin/admin_info",this.admin_form).then(res=>{
          // console.log(res)
          if(res.code=='200'){
            this.$message({
              type:"success",
